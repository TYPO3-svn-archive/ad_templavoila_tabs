...
class tx_adtemplavoilacycle_t3dimport {
	...
	public function main($params, $pObj) {
		...
		$templateObjects = t3lib_BEFunc::getRecordsByField('tx_templavoila_tmplobj', 'pid', $fieldValue, 'AND fileref = \'EXT:ad_templavoila_cycle/core_templates/fce/fce_cycle.html\'');
	...
	protected function importTemplateObjects($pid) {
		$templateObjectPath = t3lib_extMgm::extPath('ad_templavoila_cycle') . 'fec_import.t3d';
		$data = null;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ad_templavoila_cycle/class.tx_adtemplavoilacycle_t3dimport.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ad_templavoila_cycle/class.tx_adtemplavoilacycle_t3dimport.php']);
}
